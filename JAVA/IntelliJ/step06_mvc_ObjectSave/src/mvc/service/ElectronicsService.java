...
public interface ElectronicsService {
     ...
     * 전자제품 등록
     *
     * @param electronics : 최대 List에 저장된 객체의 개수가 MAX_SIZE를 벗어나면
     *                    ElectronicsArrayBoundsException 예외발생
     *                    - 예외메시지 : 배열의 길이를 벗어나 더이상 등록 할수 없습니다.
     *                    - modelNo가 중복이면 "모델 번호가 중복이므로 등록할 수 없습니다."
     */
     ...
     * (설명만 수정한다)
     *
     * @param electronics : 수정전에 모델번호에 해당하는 정보가 있는지를 찾고 없으면
     *                    SearchNotFoundException 예외발생
     ...
     *
     * @param 모델번호 :삭제전에 모델번호에 해당하는 정보가 있는지를 찾고 없으면
     *             SearchNotFoundException 예외발생
    ...
    /**
     * 종료를 클릭했을 때, 최종 Listfmf save.txt에 저장하는 기능
     **/
