...
--ex)  NT900X4D-A68 글에 댓글 3개
insert into replies values(replies_num_seq.nextval , 'NT900X4D-A68 첫번째 댓글', sysdate , 'NT900X4D-A68');
insert into replies values(replies_num_seq.nextval , 'NT900X4D-A68 두번째 댓글', sysdate , 'NT900X4D-A68');
insert into replies values(replies_num_seq.nextval , 'NT900X4D-A68 세번째 댓글', sysdate , 'NT900X4D-A68');

--ex) SHV-E250S 글에 댓글 2개
insert into replies values(replies_num_seq.nextval , 'SHV-E250S 첫번째 댓글', sysdate , 'SHV-E250S');
insert into replies values(replies_num_seq.nextval , 'SHV-E250S 두번째 댓글', sysdate , 'SHV-E250S');
