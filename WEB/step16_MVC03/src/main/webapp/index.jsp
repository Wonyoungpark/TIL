...
<body>
 ...
 <h3>
    ...
    <a href="${path}/front?key=user&methodName=login">로그인하기</a>
 ...
 <hr>
  <h3>
    ...
    <a href="${path}/front?key=goods&methodName=list">상품LIST</a>
 ...
 <h3>
    ...
    <a href="${path}/front?key=board&methodName=list">게시판 LIST</a>
